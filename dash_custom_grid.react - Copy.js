...
export default function  dash_custom_grid(props) {    
        ...
        /** Currency Value Formattter Function */
        ...
        const CurrencyTypeProvider = props => (  
              <DataTypeProvider formatterComponent={CurrencyFormatter} {...props} /*{...console.log(props)}*/  />  
              );

        const [currencyColumns] = useState(curr_col);
